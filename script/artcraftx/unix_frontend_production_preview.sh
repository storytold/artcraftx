#!/usr/bin/env bash
# This works on Linux and MacOS to launch the frontend in production preview mode

root_dir=$(pwd)
frontend_path="${root_dir}/frontend"

echo "Running ArtCraftX Frontend in Production Build + Preview Mode... (It won't hot reload!)"
echo ""
