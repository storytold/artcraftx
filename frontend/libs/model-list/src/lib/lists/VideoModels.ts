...
export const VIDEO_MODELS: VideoModel[] = [
  ...
  new VideoModel({
    id: "veo_3p1_lite",
    tauriId: "veo_3p1_lite",
    fullName: "Google Veo 3.1 Lite",
    category: "video",
    creator: ModelCreator.Google,
    selectorName: "Google Veo 3.1 Lite",
    selectorDescription: "Cheaper, lighter Veo",
    selectorBadges: ["2 min."],
    startFrame: true,
    endFrame: true,
    generateWithSound: true,
  ...
  new VideoModel({
    ...
    fullName: "Vidu Q3",
    category: "video",
    creator: ModelCreator.Vidu,
    selectorName: "Vidu Q3",
    selectorDescription: "High-quality model",
    selectorBadges: ["2 min."],
    startFrame: true,
    endFrame: true,
  ...
  new VideoModel({
    id: "vidu_q3_turbo",
    tauriId: "vidu_q3_turbo",
    fullName: "Vidu Q3 Turbo",
    category: "video",
    creator: ModelCreator.Vidu,
    selectorName: "Vidu Q3 Turbo",
    selectorDescription: "High-quality model (faster)",
    selectorBadges: ["90 sec."],
    startFrame: true,
    endFrame: true,
    generateWithSound: true,
    progressBarTime: 90000,
    maxPromptLength: 5000,
  }),
  new VideoModel({
    id: "switch_x",
