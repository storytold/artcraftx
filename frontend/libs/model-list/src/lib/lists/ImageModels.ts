...
export const IMAGE_MODELS: ImageModel[] = [
  ...
  new ImageModel({
    id: "midjourney_7",
    tauriId: "midjourney_7",
    fullName: "Midjourney v7",
    category: "image",
    creator: ModelCreator.Midjourney,
    providers: [GenerationProvider.Artcraft],
    selectorName: "Midjourney v7",
    selectorDescription: "Stunning style and quality",
    selectorBadges: ["45 sec."],
    // NB: Midjourney only supports 4 images at a time
    maxGenerationCount: 4,
  ...
  new ImageModel({
    id: "midjourney_7_niji",
    tauriId: "midjourney_7_niji",
    fullName: "Midjourney v7 Niji",
    category: "image",
    creator: ModelCreator.Midjourney,
    providers: [GenerationProvider.Artcraft],
    selectorName: "Midjourney v7 Niji",
    selectorDescription: "Anime style",
    selectorBadges: ["45 sec."],
    // NB: Midjourney only supports 4 images at a time
    maxGenerationCount: 4,
    defaultGenerationCount: 4,
  ...
  new ImageModel({
    id: "seedream_5p0_pro",
    tauriId: "seedream_5p0_pro",
    fullName: "Seedream 5.0 Pro",
    category: "image",
    creator: ModelCreator.Bytedance,
    selectorName: "Seedream 5.0 Pro",
    selectorDescription: "Highest quality Seedream",
    selectorBadges: ["60 sec."],
    tags: [ModelTag.InstructiveEdit],
    canEditImages: true,
    progressBarTime: 60000,
  ...
  new ImageModel({
    id: "seedream_5p0_pro_u",
    tauriId: "seedream_5p0_pro_u",
    fullName: "Seedream 5.0 Pro Ultra",
    category: "image",
    creator: ModelCreator.Bytedance,
    selectorName: "Seedream 5.0 Pro Ultra",
    selectorDescription: "Highest quality Seedream",
