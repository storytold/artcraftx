...
use crate::endpoint_bindings::old_bindings::index_page::get_xsid_script::{get_xsid_script, GetXsidScriptArgs};
...
use crate::endpoint_bindings::old_bindings::index_page::parsers::index::parse_index_svg_paths::parse_svg_paths_from_index_html;
...
use crate::endpoint_bindings::old_bindings::index_page::utils::select_svg_path_by_loading_anim::select_svg_path_by_loading_anim;
