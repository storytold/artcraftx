...
use crate::endpoint_bindings::old_bindings::index_page::parsers::index::parse_index_on_demand_script::parse_index_on_demand_script;
use crate::endpoint_bindings::old_bindings::index_page::parsers::script::parse_xsid_script_numbers::parse_xsid_script_numbers;
use crate::endpoint_bindings::old_bindings::index_page::requests::get_index_page_script_with_client::{get_index_page_script_with_client, GetIndexPageScriptArgs};
use crate::endpoint_bindings::old_bindings::index_page::utils::convert_verification_token_to_loading_anim::LoadingAnim;
use wreq::Client;
...
mod tests {
  ...
  use crate::endpoint_bindings::old_bindings::index_page::get_numbers::{get_numbers, GetNumbersArgs};
