...
use crate::endpoint_bindings::index_page::signature::signature_cubic_bezier_eased::signature_cubic_bezier_eased;
use crate::endpoint_bindings::index_page::signature::signature_h::signature_h;
use log::{debug, error};
...
mod tests {
  ...
  mod test_signature_simulate_style {
    use crate::endpoint_bindings::index_page::signature::signature_simulate_style::signature_simulate_style;
  ...
  mod helper_functions {
    use crate::endpoint_bindings::index_page::signature::signature_simulate_style::{is_effectively_integer, is_effectively_zero};
