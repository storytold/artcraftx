...
use crate::endpoint_bindings::index_page::requests::get_index_page_script_with_client::{get_index_page_script_with_client, GetIndexPageScriptArgs};
use log::error;
...
#[cfg(test)]
mod tests {
  use crate::endpoint_bindings::index_page::parsers::index::parse_index_script_list::parse_index_svg_paths;
  use crate::endpoint_bindings::index_page::requests::get_index_page_scripts_with_client::{get_index_page_scripts_with_client, GetIndexPageScriptsArgs};
  use crate::endpoint_bindings::index_page::requests::get_index_page_with_client::{get_index_page_with_client, GetIndexPageWithClientArgs};
