...
pub async fn generate_midjourney_v8(
  args: GenerateMidjourneyV8Args<'_>,
) -> Result<GenerateMidjourneyV8Response, Seedance2ProError> {
  ...
  Ok(GenerateMidjourneyV8Response {
...
mod tests {
  ...
  mod inner_request_tests {
    ...
    fn inner_request_preserves_all_fields() {
      let req = GenerateMidjourneyV8Request {
        prompt: "abandoned k-mart, overgrown vines".to_string(),
        aspect_ratio: GenerateMidjourneyV8AspectRatio::Portrait9x16,
        negative_prompt: Some("dark, gloomy".to_string()),
        stylize: Some(730),
        weird: Some(2050),
        chaos: Some(70),
        quality: Some(GenerateMidjourneyV8Quality::Half),
        raw_mode: true,
        batch_count: KinoviMidjourneyBatchCount::Four,
        reference_image_urls: Some(vec!["https://example.com/ref.jpg".to_string()]),
      };
    ...
    fn every_aspect_ratio_maps_to_canonical_wire_string() {
      let cases = [
        (GenerateMidjourneyV8AspectRatio::Square1x1, "1:1"),
        (GenerateMidjourneyV8AspectRatio::Landscape16x9, "16:9"),
        (GenerateMidjourneyV8AspectRatio::Portrait9x16, "9:16"),
        (GenerateMidjourneyV8AspectRatio::UltraWide21x9, "21:9"),
        (GenerateMidjourneyV8AspectRatio::UltraTall9x21, "9:21"),
        (GenerateMidjourneyV8AspectRatio::Standard4x3, "4:3"),
        (GenerateMidjourneyV8AspectRatio::Portrait3x4, "3:4"),
        (GenerateMidjourneyV8AspectRatio::Wide5x4, "5:4"),
        (GenerateMidjourneyV8AspectRatio::Tall4x5, "4:5"),
        (GenerateMidjourneyV8AspectRatio::Wide3x2, "3:2"),
        (GenerateMidjourneyV8AspectRatio::Tall2x3, "2:3"),
      ];
    ...
    fn every_quality_maps_to_canonical_wire_string() {
      let cases = [
        (GenerateMidjourneyV8Quality::Quarter, "0.25"),
        (GenerateMidjourneyV8Quality::Half, "0.5"),
        (GenerateMidjourneyV8Quality::Full, "1"),
      ];
      for (variant, expected) in cases {
  ...
  mod real_requests {
    ...
    async fn test_generate_v8_minimal() -> AnyhowResult<()> {
      ...
      let result = generate_midjourney_v8(GenerateMidjourneyV8Args {
        session: &session,
        host_override: None,
        request: GenerateMidjourneyV8Request {
          prompt: "spooky horror scene, ghosts".to_string(),
          aspect_ratio: GenerateMidjourneyV8AspectRatio::Portrait9x16,
          negative_prompt: None,
          stylize: None,
          weird: None,
          chaos: None,
          quality: Some(GenerateMidjourneyV8Quality::Full),
          raw_mode: false,
      ...
      let result = generate_midjourney_v8(GenerateMidjourneyV8Args {
        ...
        request: GenerateMidjourneyV8Request {
          ...
          reference_image_urls: Some(vec![
            "https://static.seedance2-pro.com/materials/20260602/1780380104765-10cec276.jpg".to_string(),
          ]),
        },
      }).await?;
