...
impl From<String> for ApiClientImageModel {
  fn from(value: String) -> Self {
    match value.as_str() {
      ...
      "seedream_5p0_pro" => Self::Seedream5p0Pro,
      "seedream_5p0_pro_u" => Self::Seedream5p0ProUltra,
...
impl From<ApiClientImageModel> for String {
  fn from(value: ApiClientImageModel) -> Self {
    match value {
      ...
      ApiClientImageModel::Seedream5p0Pro => "seedream_5p0_pro".to_string(),
      ApiClientImageModel::Seedream5p0ProUltra => "seedream_5p0_pro_u".to_string(),
...
mod tests {
  ...
  fn every_known_variant_round_trips() {
    let all = [
      ...
      (ApiClientImageModel::Seedream5p0Pro, "seedream_5p0_pro"),
      (ApiClientImageModel::Seedream5p0ProUltra, "seedream_5p0_pro_u"),
