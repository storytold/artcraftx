...
/// Over-the-wire input shape for `fal-ai/meshy/v6/text-to-3d`.
/// fal's schema: <https://fal.ai/models/fal-ai/meshy/v6/text-to-3d/api>
#[derive(Debug, Serialize, Deserialize, Default)]
pub struct MeshyV6TextToMeshInput {
  /// Text prompt (max 600 characters).
  pub prompt: String,

  /// Options: "preview", "full". fal default: "full".
...
pub struct MeshyV6TextToMeshOutput {}
