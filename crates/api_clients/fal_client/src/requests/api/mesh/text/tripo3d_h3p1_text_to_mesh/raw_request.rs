...
/// Over-the-wire input shape for `tripo3d/h3.1/text-to-3d`.
/// fal's schema: <https://fal.ai/models/tripo3d/h3.1/text-to-3d/api>
#[derive(Debug, Serialize, Deserialize, Default)]
pub struct Tripo3dH3p1TextToMeshInput {
  /// Text prompt (max 1024 characters).
  pub prompt: String,
...
pub struct Tripo3dH3p1TextToMeshOutput {}
