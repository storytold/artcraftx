...
/// Over-the-wire input shape for `tripo3d/h3.1/multiview-to-3d`.
/// fal's schema: <https://fal.ai/models/tripo3d/h3.1/multiview-to-3d/api>
#[derive(Debug, Serialize, Deserialize, Default)]
pub struct Tripo3dH3p1MultiviewToMeshInput {
...
pub struct Tripo3dH3p1MultiviewToMeshOutput {}
