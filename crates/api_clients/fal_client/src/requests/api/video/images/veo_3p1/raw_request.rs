...
/// Over-the-wire input shape for `fal-ai/veo3.1/first-last-frame-to-video`
/// (start + end keyframes).
/// fal's schema: <https://fal.ai/models/fal-ai/veo3.1/first-last-frame-to-video/api>
#[derive(Debug, Serialize, Deserialize, Default)]
pub struct Veo3p1FirstLastFrameToVideoInput {
  pub prompt: String,
...
pub struct Veo3p1FirstLastFrameToVideoVideoFile {
  pub url: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct Veo3p1FirstLastFrameToVideoOutput {
  pub video: Veo3p1FirstLastFrameToVideoVideoFile,
}
