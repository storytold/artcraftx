...
use crate::requests::api::video::images::veo_3p1_fast::raw_request::{
  Veo3p1FastFirstLastFrameToVideoInput, Veo3p1FastFirstLastFrameToVideoOutput,
};
...
mod tests {
  ...
  async fn test_first_last_frame_webhook() -> AnyhowResult<()> {
    ...
    let request = Veo3p1FastFirstLastFrameToVideoRequest {
      ...
      aspect_ratio: Some(Veo3p1FastFirstLastFrameToVideoAspectRatio::SixteenByNine),
      duration: Some(Veo3p1FastFirstLastFrameToVideoDuration::FourSeconds),
      resolution: Some(Veo3p1FastFirstLastFrameToVideoResolution::SevenTwentyP),
  ...
  fn raw_request_maps_all_fields() {
    let request = Veo3p1FastFirstLastFrameToVideoRequest {
      ...
      seed: Some(1),
      auto_fix: Some(true),
      safety_tolerance: Some(Veo3p1FastFirstLastFrameToVideoSafetyTolerance::Level3),
    };
  ...
  fn endpoint_path_is_canonical() {
    assert_eq!(
      Veo3p1FastFirstLastFrameToVideoRequest::ENDPOINT,
