...
use crate::requests::api::video::image::vidu_q3::raw_request::{
  ViduQ3ImageToVideoInput, ViduQ3ImageToVideoOutput,
};
...
mod tests {
  ...
  fn raw_request_maps_all_fields() {
    let request = ViduQ3ImageToVideoRequest {
      ...
      duration: Some(7),
      seed: Some(42),
      resolution: Some(ViduQ3ImageToVideoResolution::TenEightyP),
      audio: Some(false),
    };
  ...
  fn endpoint_path_is_canonical() {
    assert_eq!(
      ViduQ3ImageToVideoRequest::ENDPOINT,
