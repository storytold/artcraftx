...
/// Over-the-wire input shape for `fal-ai/vidu/q3/image-to-video`.
/// fal's schema: <https://fal.ai/models/fal-ai/vidu/q3/image-to-video/api>
///
/// NB: this endpoint has no `aspect_ratio` (it is derived from the input
/// image). A `prompt` is optional server-side but always sent here.
#[derive(Debug, Serialize, Deserialize, Default)]
pub struct ViduQ3ImageToVideoInput {
...
pub struct ViduQ3ImageToVideoVideoFile {
  pub url: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct ViduQ3ImageToVideoOutput {
  pub video: ViduQ3ImageToVideoVideoFile,
}
