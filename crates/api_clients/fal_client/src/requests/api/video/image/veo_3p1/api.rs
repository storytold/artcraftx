...
use crate::requests::api::video::image::veo_3p1::raw_request::{
  Veo3p1ImageToVideoInput, Veo3p1ImageToVideoOutput,
};
...
mod tests {
  ...
  async fn test_image_to_video_webhook() -> AnyhowResult<()> {
    ...
    let request = Veo3p1ImageToVideoRequest {
      ...
      duration: Some(Veo3p1ImageToVideoDuration::FourSeconds),
      resolution: Some(Veo3p1ImageToVideoResolution::SevenTwentyP),
  ...
  fn raw_request_maps_all_fields() {
    let request = Veo3p1ImageToVideoRequest {
      ...
      aspect_ratio: Some(Veo3p1ImageToVideoAspectRatio::Auto),
      duration: Some(Veo3p1ImageToVideoDuration::SixSeconds),
      resolution: Some(Veo3p1ImageToVideoResolution::TenEightyP),
      generate_audio: Some(false),
      negative_prompt: Some("nope".to_string()),
      seed: Some(7),
      auto_fix: Some(true),
      safety_tolerance: Some(Veo3p1ImageToVideoSafetyTolerance::Level2),
    };
  ...
  fn every_aspect_ratio_maps_to_wire_string() {
    for (variant, expected) in [
      (Veo3p1ImageToVideoAspectRatio::Auto, "auto"),
      (Veo3p1ImageToVideoAspectRatio::SixteenByNine, "16:9"),
      (Veo3p1ImageToVideoAspectRatio::NineBySixteen, "9:16"),
    ] {
  ...
  fn endpoint_path_is_canonical() {
    assert_eq!(
      Veo3p1ImageToVideoRequest::ENDPOINT,
