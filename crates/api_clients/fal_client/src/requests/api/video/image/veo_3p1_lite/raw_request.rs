...
/// Over-the-wire input shape for `fal-ai/veo3.1/lite/image-to-video`
/// (single start-frame keyframe).
/// fal's schema: <https://fal.ai/models/fal-ai/veo3.1/lite/image-to-video/api>
#[derive(Debug, Serialize, Deserialize, Default)]
pub struct Veo3p1LiteImageToVideoInput {
  pub prompt: String,
...
pub struct Veo3p1LiteImageToVideoVideoFile {
  pub url: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct Veo3p1LiteImageToVideoOutput {
  pub video: Veo3p1LiteImageToVideoVideoFile,
}
