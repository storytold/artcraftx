...
/// Over-the-wire input shape for `fal-ai/veo3.1/lite` (text-to-video).
/// fal's schema: <https://fal.ai/models/fal-ai/veo3.1/lite/api>
#[derive(Debug, Serialize, Deserialize, Default)]
pub struct Veo3p1LiteTextToVideoInput {
  pub prompt: String,
...
pub struct Veo3p1LiteTextToVideoVideoFile {
  pub url: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct Veo3p1LiteTextToVideoOutput {
  pub video: Veo3p1LiteTextToVideoVideoFile,
}
