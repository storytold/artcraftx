...
use crate::requests::api::video::extend::veo_3p1::raw_request::{
  Veo3p1ExtendVideoInput, Veo3p1ExtendVideoOutput,
};
...
mod tests {
  ...
  async fn test_extend_video_webhook() -> AnyhowResult<()> {
    ...
    let request = Veo3p1ExtendVideoRequest {
      ...
      aspect_ratio: None,
      duration: Some(Veo3p1ExtendVideoDuration::SevenSeconds),
      resolution: Some(Veo3p1ExtendVideoResolution::SevenTwentyP),
  ...
  fn raw_request_maps_all_fields() {
    let request = Veo3p1ExtendVideoRequest {
      ...
      aspect_ratio: Some(Veo3p1ExtendVideoAspectRatio::SixteenByNine),
      duration: Some(Veo3p1ExtendVideoDuration::SevenSeconds),
      resolution: Some(Veo3p1ExtendVideoResolution::TenEightyP),
      negative_prompt: Some("nope".to_string()),
      generate_audio: Some(true),
      seed: Some(3),
      auto_fix: Some(false),
      safety_tolerance: Some(Veo3p1ExtendVideoSafetyTolerance::Level4),
    };
  ...
  fn every_duration_maps_to_wire_string_and_seconds() {
    for (variant, s, secs) in [
      (Veo3p1ExtendVideoDuration::FourSeconds, "4s", 4),
      (Veo3p1ExtendVideoDuration::SixSeconds, "6s", 6),
      (Veo3p1ExtendVideoDuration::SevenSeconds, "7s", 7),
      (Veo3p1ExtendVideoDuration::EightSeconds, "8s", 8),
    ] {
  ...
  fn endpoint_path_is_canonical() {
    assert_eq!(
      Veo3p1ExtendVideoRequest::ENDPOINT,
