...
/// Over-the-wire input shape for `fal-ai/veo3.1/extend-video`.
/// Extends an existing video by generating a continuation.
/// fal's schema: <https://fal.ai/models/fal-ai/veo3.1/extend-video/api>
#[derive(Debug, Serialize, Deserialize, Default)]
pub struct Veo3p1ExtendVideoInput {
  pub prompt: String,
...
pub struct Veo3p1ExtendVideoVideoFile {
  pub url: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct Veo3p1ExtendVideoOutput {
  pub video: Veo3p1ExtendVideoVideoFile,
}
