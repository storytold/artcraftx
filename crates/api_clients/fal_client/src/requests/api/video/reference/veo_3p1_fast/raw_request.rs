...
/// Over-the-wire input shape for `fal-ai/veo3.1/fast/reference-to-video`.
/// Reference images drive subject/appearance consistency.
/// fal's schema: <https://fal.ai/models/fal-ai/veo3.1/fast/reference-to-video/api>
///
/// NB: unlike the other Veo 3.1 Fast modalities, this endpoint's schema does
/// NOT expose `negative_prompt` or `seed`.
#[derive(Debug, Serialize, Deserialize, Default)]
pub struct Veo3p1FastReferenceToVideoInput {
  pub prompt: String,
...
pub struct Veo3p1FastReferenceToVideoVideoFile {
  pub url: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct Veo3p1FastReferenceToVideoOutput {
  pub video: Veo3p1FastReferenceToVideoVideoFile,
}
