...
pub fn build_artcraft_marble_1p1(builder: GenerateSplatRequestBuilder) -> Result<SplatGenerationRequest, ArtcraftRouterError> {
  ...
  Ok(SplatGenerationRequest::ArtcraftMarble1p1(state))
}
