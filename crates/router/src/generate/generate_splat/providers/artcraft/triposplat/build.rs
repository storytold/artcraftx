...
pub fn build_artcraft_triposplat(builder: GenerateSplatRequestBuilder) -> Result<SplatGenerationRequest, ArtcraftRouterError> {
  ...
  Ok(SplatGenerationRequest::ArtcraftTripoSplat(state))
}
