...
pub fn build_artcraft_marble_1p0(builder: GenerateSplatRequestBuilder) -> Result<SplatGenerationRequest, ArtcraftRouterError> {
  ...
  Ok(SplatGenerationRequest::ArtcraftMarble1p0(state))
}
