...
pub fn build_artcraft_marble_1p0_draft(builder: GenerateSplatRequestBuilder) -> Result<SplatGenerationRequest, ArtcraftRouterError> {
  ...
  Ok(SplatGenerationRequest::ArtcraftMarble1p0Draft(state))
}
