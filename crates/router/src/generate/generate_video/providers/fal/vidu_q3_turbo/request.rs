...
mod tests {
  ...
  use fal_client::requests::api::video::text::vidu_q3_turbo::api::{
    ViduQ3TurboTextToVideoAspectRatio, ViduQ3TurboTextToVideoResolution,
  };
  ...
  async fn send_text_to_video_webhook() {
    let state = FalViduQ3TurboRequestState {
      mode: FalViduQ3TurboMode::TextToVideo(ViduQ3TurboTextToVideoRequest {
  ...
  async fn send_image_to_video_webhook() {
    let state = FalViduQ3TurboRequestState {
      mode: FalViduQ3TurboMode::ImageToVideo(ViduQ3TurboImageToVideoRequest {
