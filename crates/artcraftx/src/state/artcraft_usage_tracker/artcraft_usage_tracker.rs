...
impl ArtcraftUsageTracker {
  ...
  pub fn record_image_generation(&self, num_images: u16, usage_type: ArtcraftUsageType, page: ArtcraftUsagePage) -> Result<(), ArtcraftXError> {
  ...
  pub fn record_video_generation(&self, num_videos: u16, usage_type: ArtcraftUsageType, page: ArtcraftUsagePage) -> Result<(), ArtcraftXError> {
    let mut data = self.get()?;
  ...
  pub fn record_object_generation(&self, num_objects: u16, usage_type: ArtcraftUsageType, page: ArtcraftUsagePage) -> Result<(), ArtcraftXError> {
    let mut data = self.get()?;
  ...
  pub fn get(&self) -> Result<ArtcraftUsageTrackerData, ArtcraftXError> {
  ...
  fn set(&self, data: ArtcraftUsageTrackerData) -> Result<(), ArtcraftXError> {
