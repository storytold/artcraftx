use crate::api_adapters::aspect_ratio::common_aspect_ratio::CommonAspectRatio as CommonAspectRatio2;
use crate::api_adapters::resolution::common_resolution::CommonResolution as CommonResolution2;
...
use crate::commands::deprecated::text_to_image::enqueue_text_to_image_command::{
