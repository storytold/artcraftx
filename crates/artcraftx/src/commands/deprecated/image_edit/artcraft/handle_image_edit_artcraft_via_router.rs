use crate::api_adapters::aspect_ratio::common_aspect_ratio::CommonAspectRatio as DesktopCommonAspectRatio;
use crate::commands::enqueue::generate_error::{BadInputReason, GenerateError, MissingCredentialsReason};
use crate::commands::deprecated::image_edit::enqueue_edit_image_command::{
