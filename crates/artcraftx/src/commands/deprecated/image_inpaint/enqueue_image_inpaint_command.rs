...
use crate::commands::deprecated::image_inpaint::artcraft::handle_inpaint_artcraft::handle_inpaint_artcraft;
use crate::commands::deprecated::image_inpaint::inpaint_models::image_inpaint_model_to_model_type;
