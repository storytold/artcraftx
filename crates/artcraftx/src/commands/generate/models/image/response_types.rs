...
impl From<ApiClientImageModel> for ListImageModelsImageModel {
  fn from(value: ApiClientImageModel) -> Self {
    match value {
      ...
      ApiClientImageModel::Seedream5p0Pro => Self::Seedream5p0Pro,
      ApiClientImageModel::Seedream5p0ProUltra => Self::Seedream5p0ProUltra,
...
impl From<ListImageModelsImageModel> for String {
  fn from(value: ListImageModelsImageModel) -> Self {
    match value {
      ...
      ListImageModelsImageModel::Seedream5p0Pro => "seedream_5p0_pro".to_string(),
      ListImageModelsImageModel::Seedream5p0ProUltra => "seedream_5p0_pro_u".to_string(),
