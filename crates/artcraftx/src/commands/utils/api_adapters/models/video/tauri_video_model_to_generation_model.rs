...
pub fn tauri_video_model_to_generation_model(model: TauriVideoModel) -> GenerationModel {
  match model {
    ...
    TauriVideoModel::Seedance2p0Mini => GenerationModel::Seedance2p0Mini,
    TauriVideoModel::Seedance2p5 => GenerationModel::Seedance2p5,
    TauriVideoModel::Seedance2p5Edit => GenerationModel::Seedance2p5Edit,
    TauriVideoModel::MinimaxH3 => GenerationModel::MinimaxH3,
